      ...
      const pdfBuffer: Buffer = await new Promise(async (resolve, reject) => {
          ...
          for (let i = 0; i < pages; i++) {
              ...
              doc
                  ...
                  .font("Helvetica-Bold")
                  .fontSize(15)
                  .text(data[i].city, marginlefttext1 + 93, initLine + lineHeight * 11)
                  .text(data[i].province, marginlefttext1 + 93, initLine + lineHeight * 12.5)
                  .fontSize(10)
                  .font("Helvetica-Bold")
                  .text("Destinatario:", marginlefttext1, secondLine + lineHeight * 3.6)
                  .font("Helvetica")
                  .text(this.overflowText(data[i].recipient, 48), marginlefttext1 + 63, secondLine + lineHeight * 3.6, { width: 150, lineGap: 4 })
                  //.font("Helvetica-Bold")
                  ...
                  .font("Helvetica")
                  .text(this.overflowText(data[i].address, 40), marginlefttext1 + 50, secondLine + lineHeight * 4.9, { width: 120, lineGap: 4 })
                  .font("Helvetica-Bold")
    ...
    const pdfBuffer: Buffer = await new Promise(async (resolve, reject) => {
        ...
        for (let i = 0; i < pages; i++) {
            ...
            doc
                ...
                .font("Helvetica")
                .text(this.overflowText(data[i].companyName, 45), marginlefttext1 + 40, initLine + lineHeight * 4, { width: 200, lineGap: 4 })
                .font("Helvetica-Bold")
                .text("Direccion:", marginlefttext1, initLine + lineHeight * 5.5)
                .font("Helvetica")
                .text(this.overflowText(data[i].address, 48), marginlefttext1 + 56, initLine + lineHeight * 5.5, { width: 200, lineGap: 4 }) // no es adress de destino
                .font("Helvetica-Bold")
                ...
                .font("Helvetica-Bold")
                .fontSize(15)
                .text(data[i].city, marginlefttext1 + 93, thirdLine + lineHeight * 6.2)
                .text(data[i].province, marginlefttext1 + 93, thirdLine + lineHeight * 7.5)
                .fontSize(10.5)
                .font("Helvetica-Bold")
                .text("Destinatario:", marginlefttext1, forthLine + lineHeight)
                .font("Helvetica")
                .text(this.overflowText(data[i].recipient, 48), marginlefttext1 + 65, forthLine + lineHeight, { width: 150, lineGap: 4 })
                //.font("Helvetica-Bold")
                ...
                .font("Helvetica")
                .text(this.overflowText(data[i].address, 40), marginlefttext1 + 52, forthLine + lineHeight * 2.5, { width: 120, lineGap: 4 })
                .font("Helvetica-Bold")
    ...
    const pdfBuffer: Buffer = await new Promise(async (resolve, reject) => {
        ...
        for (let i = 0; i < pages; i++) {
            ...
            doc
                ...
                .font("Helvetica")
                .text(this.overflowText(data[i].companyName, 45), marginlefttext1 + 42, secondLine + lineHeight * 7, { width: 200, lineGap: 4 })
                .font("Helvetica-Bold")
                .text("Direccion:", marginlefttext1, secondLine + lineHeight * 8.5)
                .font("Helvetica")
                .text(this.overflowText(data[i].address, 48), marginlefttext1 + 54, secondLine + lineHeight * 8.5, { width: 200, lineGap: 4 }) // no es adress de destino
                .font("Helvetica-Bold")
                ...
                .font("Helvetica-Bold")
                .fontSize(15)
                .text(data[i].city, marginlefttext1 + 93, forthLine + lineHeight * 6.5)
                .text(data[i].province, marginlefttext1 + 93, forthLine + lineHeight * 8)
                ...
                .font("Helvetica")
                .text(this.overflowText(data[i].recipient, 48), marginlefttext1 + 65, fifthLine + lineHeight, { width: 150, lineGap: 4 })
                //.font("Helvetica-Bold")
                ...
                .font("Helvetica")
                .text(this.overflowText(data[i].address, 40), marginlefttext1 + 52, fifthLine + lineHeight * 2.5, { width: 120, lineGap: 4 })
                .font("Helvetica-Bold")
