...
class AccountCreatedDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, companyName: { required: true, type: () => String }, codeECO: { required: true, type: () => String }, accountType: { required: true, type: () => String }, filePath: { required: true, type: () => String } };
    }
}
__decorate([
