...
let JwtStrategy = class JwtStrategy extends passport_1.PassportStrategy(passport_jwt_2.Strategy) {
    constructor(userService, config) {
        super({
            ...
            secretOrKey: config.get(constants_1.JWT_SECRET),
        });
    ...
    async validate(payload) {
        ...
        return Object.assign(Object.assign({}, userRol), { roles: userRol.role.name, companyName: userRol.account.companyName });
    }
};
